...
# Extract relevant information from the "Time" column
...
features = cleaned_data.drop(['Voyage', 'Time', 'Hour','DayOfWeek', 'Total_Fuel_Consumption', 'Avg Fuel Consumption', 'QM2_Boiler_Aft_Usage_Mass_Flow','QM2_Boiler_Fwd_Usage_Mass_Flow', 'QM2_DG01_Usage_Mass_Flow',
