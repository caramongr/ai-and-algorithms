...
data = pd.read_excel('MasterDataFilemod.xlsx')

# Data Preprocessing: Drop rows with missing values
cleaned_data = data.dropna()

# Feature Selection: Exclude non-numeric and target variable columns
features = cleaned_data.drop(['Voyage', 'Year', 'Departure_Arrival', 'Time', 'Total_Fuel_Consumption','Avg Fuel Consumption'], axis=1)
...
input_features = {
    ...
    'QM2_Ship_Outside_Pressure': 2000,
