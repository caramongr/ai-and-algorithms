...
southampton_latitude = 50.9
southampton_longitude = -1.4
...
def predict_and_evaluate(custom_inputs=None):
    ...
    excluded_features = [ 'Voyage', 'Time', 'Departure_Arrival']  # Exclude 'Departure_Arrival' here
...
custom_inputs = {
    ...
    # 'QM2_NAV_Latitude': southampton_latitude,
    # 'QM2_NAV_Longitude': southampton_longitude,
}
